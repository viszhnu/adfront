      ...
      <div class="teacher-name">
        ...
        <div class="col-sm-3">
          <div class="button pull-right">
            <Link to={`/edituser/${props.match.params.id}`} class="btn btn-outline-success btn-sm">Edit Profile <i class="fa fa-pencil"></i></Link>
          </div>
        </div>
        </div>
      </div>
  ...
  <div class="row">
    <div class="col-sm-12">
        <div class="card card-block">
          ...
          <ul class="list-group" style={{marginTop:"15px" ,marginBottom:"15px"}}>
